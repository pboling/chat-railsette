...
//      console.log('[jquery-environment] DOM-having options',options);
...
//        console.log(Environment.configured_elements.length, 'pre-existing element configurations');
      } else {
...
//        console.log('Environment.configured_elements',Environment.configured_elements);
      });
    },
...
//      console.log('set',key,'to',value);
      var result = [];
      this.each(function() {
//        console.log('configured:', Environment.configured_elements[$(this).selector]);
...
//      console.log('get',key);
    ...
    all : function () {
      var result = [];
      this.each(function() {
//        console.log('getting configured environment for',$(this).selector);
        if (Environment.configured_elements[$(this).selector] !== undefined) {
...
//    console.log('[jquery-environment] DOM-free options',options);
...
//      console.log('configured:', Environment.configured);
    } else {
      console.log('not configured');
      return undefined;
    }
...
//      console.log('hot dog',Environment.configured.config);
      return Environment.configured.config;
    }
  }
